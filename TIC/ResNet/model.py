...
class ResNet(nn.Module):
    def __init__(
        ...
        layers: List[int],
        num_classes: int = 1000, # Default to ImageNet's 1000 classes
...
def _resnet(
    ...
    **kwargs: Any
    ...
    # Note: Pretrained weights loading is removed as it's usually handled outside the model definition
    # if pretrained:
