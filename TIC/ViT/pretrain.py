...
if __name__ == '__main__':
  ...
  USE_PRETRAINED = False # Use pretrained ViT weights
  SCHEDULER_TYPE = 'linear' # 'linear' or 'none'
  ...
  SAVE_PATH = os.path.join(CHECKPOINT_DIR, 'ViT_model_pertrain_{epoch}.pth')
  MAX_TOLERANT_EPOCH = 3
  LOG_NAME = 'ViT_pretrain'
  ...
  num_training_steps = (len(dataset) - len(dataset)//10) // BATCH_SIZE * NUM_EPOCHS 
